...
def load_songs_in_kern(dataset_path):
    ...
    for path, subdir, files in os.walk(dataset_path):          #recursively goes through all the files in the folder
        for file in files:
            if file[-3:] == 'krn':
...
def has_acceptable_duration(song, acceptable_durations):
    for note in song.flat.notesAndRests:        #filters out notes
